...
//Dog là một lớp kế thừa Animal và cài đặt interface Pet và Guard
//Do đó, Dog có các phương thức của Animal đã cài đặt và Dog cần cài đặt các phương thức quy định bởi interface Pet và Guard
// Dog là lớp cụ thể đầu tiên trên câu thừa kế, nên Dog buộc phải cài đặt tất cả các phương thức abstract trong các lớp cha của nó
...
public class Dog extends Animal implements Pet, Guard {
    ...
    @Override
    public void sleep() {
        System.out.println("Dog " + name + " is sleeping, yet doing security guard");
    }
