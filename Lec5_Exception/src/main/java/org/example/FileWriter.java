...
public class FileWriter {
    ...
    public static void read(String filename) throws FileNotFoundException {
        ...
        //Constructor Scanner(File) (dòng 18) có thể ném ra một exception thuộc loại FileNotFoundException
        //Trong chương trình có gọi đến constructor Scanner, cần xử lý exception này.
