...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //Khối logic được bọc trong khối try, khối này có thể ném ra ngoại lệ
        ...
        try {
            ...
            //vì các ngoại lệ này  thường gây ra bởi lỗi logic của lập trình viên.
            //Do đó, với các ngoại lệ này bạn có thể xử lý bằng khối try-catch, hoặc ném tiếp, hoặc không làm gì cả
            // Compiler vẫn dịch chương trình thành công
            ...
            //khi thực hiện phép chia trong fraction có thể xảy ra ngoại lệ ArithmeticException nếu mẫu số bằng 0
        ...
        //khi main gọi đến read, phương thức main cần xử lý ngoại lệ này (bọc trong khối try/catch hoặc né bằng cách ném tiếp) nếu không compiler sẽ không cho dịch chương trình
        ...
        //và khi đó chương trình vẫn bị crashed
