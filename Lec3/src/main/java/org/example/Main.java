...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Initializing a Dog with name Jerry");
        array_animals[0] = new Dog("Jerry");
        System.out.println("-------------------");

        System.out.println("Initializing a Cat with name Cherry");
        array_animals[1] = new Cat("Cherry");
        System.out.println("-------------------");

        System.out.println("Initializing a BlueDog with name Tom");
        array_animals[2] = new BlueDog("Tom");
        System.out.println("-------------------");


        System.out.println("Invoking method makeNoise of each objects:");
        //Cách duyệt mảng thứ nhất: Duyệt mảng bằng cách duyệt từng chỉ số
        for(int i = 0; i < array_animals.length; i++){
            //kiểu tham chiếu là kiểu Animal, trình biên dịch sẽ kiểm tra xem Animal có cài đặt makeNoise không, nếu có thì sẽ dịch thành công.
        ...
        //Cách duyệt mảng thứ 2: Duyệt mảng bằng for each
...
//        System.out.println("--------------------------");
        ...
        //chúng ta cũng có thể dùng một ArrayList để "lưu" các đối tượng
        //ArrayList là lớp cung cấp bởi thư viện Java
        //cần import java.util.ArrayList; (dòng 3 của file này) trước khi sử dụng ArrayList
        ArrayList<Animal> arraylist_animals = new ArrayList<>();
        arraylist_animals.add(new Dog("Jerry"));
        arraylist_animals.add(new BlueDog("Tom"));
